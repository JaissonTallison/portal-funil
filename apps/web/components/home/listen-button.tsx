...
export function ListenButton({ text }: { text: string }) {
  ...
  return (
    <button
      onClick={toggle}
      className="flex shrink-0 items-center gap-2 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-xs font-bold text-slate-600 transition hover:bg-slate-100"
    >
