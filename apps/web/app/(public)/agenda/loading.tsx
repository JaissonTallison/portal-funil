    ...
    <main className="min-h-screen bg-surface">
      <div className="animate-pulse bg-navy px-4 py-14 md:px-6 md:py-20">
        <div className="mx-auto max-w-[1440px]">
          ...
          <div className="mt-8 h-16 w-80 rounded-xl bg-white/10" />
          <div className="mt-5 h-4 w-64 rounded-lg bg-white/10" />
        </div>
      </div>
      ...
      <div className="mx-auto max-w-[1440px] px-4 py-10 md:px-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="overflow-hidden rounded-[12px] border border-black/5 bg-white">
