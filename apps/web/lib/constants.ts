...
export const BREAKING_NEWS = [
  ...
  "Espanha goleia por 3 a 1 em amistoso e chega à Copa 2026 como uma das favoritas ao título",
  "Trump é vaiado na final da NBA em San Francisco — vídeo viraliza com 30 milhões de views",
  "Nunes Marques suspende pesquisa eleitoral do TSE; Flávio Bolsonaro celebra a decisão",
