...
export const columnists: Columnist[] = [
  ...
  {
    id: "c6",
    slug: "matheus-marques",
    name: "Matheus Marques",
    role: "Música & Rock",
    specialty: "Rock e Heavy Metal",
    bio: "Analista de sistemas e DevOps, além de músico de Manaus, Matheus Marques assina a coluna de música e rock do Portal Funil, com foco na cena local: shows, bandas e as casas que mantêm o rock vivo na cidade.",
    avatar: "/colunistas/matheus-marques.png",
    articleIds: [],
    articleSlugs: ["judas-priest-no-condado-banda-exception-faz-show-na-sexta-25-as-23h"],
    social: { instagram: "@mathx_marques" },
  },
  {
    id: "c7",
    slug: "hadson-sales",
    name: "Hadson Sales",
    role: "Carros & Mobilidade",
    specialty: "Mercado Automotivo",
    bio: "Engenheiro civil e bacharel em Direito, Hadson Sales assina a coluna de carros e mobilidade do Portal Funil, com foco no mercado automotivo, nos carros elétricos e no que muda para quem dirige em Manaus e no Norte.",
    avatar: "/colunistas/hadson-sales.jpg",
    articleIds: [],
    articleSlugs: ["manaus-lidera-mercado-de-carros-eletricos-no-norte-com-7-6-mil-veiculos"],
  },
  {
    id: "c10",
    slug: "mariana-normando",
    name: "Mariana Normando",
    role: "Arquitetura & Design",
    specialty: "Arquitetura",
    bio: "Arquiteta, Mariana Normando assina a coluna de arquitetura do Portal Funil, com foco em projetos, conforto e no jeito de construir e morar em Manaus e na Amazônia.",
    avatar: "/colunistas/mariana-normando.png",
    articleIds: [],
    articleSlugs: ["arquitetura-para-o-clima-de-manaus-conforto-comeca-no-projeto"],
  },
  {
    id: "c9",
    slug: "jorge-fernando-farias",
    name: "Jorge Fernando Farias, Ph.D.",
    role: "Estratégia & Governança",
    specialty: "Governança Corporativa",
    bio: "Fundador e CEO da J4G Tecnologia, atuante desde 2001, Jorge Fernando Farias, Ph.D., assina a coluna de estratégia e governança do Portal Funil. Com mais de 25 anos de mercado e mais de 300 projetos, segundo a própria empresa, escreve sobre governança corporativa, captação de recursos e ESG e sustentabilidade.",
    avatar: "/colunistas/jorge-fernando-farias.png",
    articleIds: [],
    articleSlugs: ["tecnologia-sem-estrategia-e-apenas-codigo-governanca-captacao-de-recursos-e-esg"],
  },
  {
    id: "c8",
    slug: "jaisson-tallison",
    name: "Jaisson Tallison",
    role: "Tecnologia & IA",
    specialty: "Inteligência Artificial",
    bio: "Engenheiro da computação e analista de sistemas, Jaisson Tallison assina a coluna de tecnologia do Portal Funil, com foco em inteligência artificial, software e no impacto da tecnologia no dia a dia.",
    avatar: "/colunistas/jaisson-tallison.png",
    articleIds: [],
    articleSlugs: [
      "data-centers-para-ia-arquitetura-escalabilidade-e-desafios-computacionais",
      "como-a-inteligencia-artificial-poderia-matar-todo-mundo-exatamente",
    ],
  },
];
