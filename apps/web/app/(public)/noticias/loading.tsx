    ...
    <main className="min-h-screen bg-surface">
      ...
      <section className="bg-navy px-6 py-16">
        <div className="mx-auto max-w-[1440px]">
          ...
          <div className="mt-6 h-16 w-96 animate-pulse rounded-xl bg-white/10" />
          <div className="mt-4 h-5 w-48 animate-pulse rounded-lg bg-white/10" />
        ...
        <div className="mx-auto max-w-[1440px]">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {Array.from({ length: 8 }).map((_, i) => (
              <div key={i} className="overflow-hidden rounded-[16px] border border-black/5 bg-white">
