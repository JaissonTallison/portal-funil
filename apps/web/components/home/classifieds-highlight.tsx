...
import { getFeaturedListings, formatPrice, getCategoryNameBySlug, getTypeName } from "@/lib/classifieds";

export function ClassifiedsHighlight() {
        ...
        <div className="mb-8 flex flex-wrap items-end justify-between gap-6">
          <div>
            ...
            <p className="mt-3 max-w-xl text-lg text-slate-500">
              Anúncios em destaque da comunidade — eletrônicos, veículos, imóveis,
